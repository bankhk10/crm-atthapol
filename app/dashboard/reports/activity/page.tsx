  ...
  return (
    <>
      ...
      <Box display="grid" gridTemplateColumns={{ xs: "1fr", md: "repeat(4, 1fr)" }} gap={2} mt={1}>
        ...
        <Box>
          <KpiCard
            label={data.kpis.meetings.label}
            value={data.kpis.meetings.value}
            delta={data.kpis.meetings.delta}
          />
        </Box>
        <Box>
          <KpiCard
            label={data.kpis.calls.label}
            value={data.kpis.calls.value}
            delta={data.kpis.calls.delta}
          />
        </Box>
        <Box>
          <KpiCard
            label={data.kpis.tasks.label}
            value={data.kpis.tasks.value}
            delta={data.kpis.tasks.delta}
          />
        </Box>
      </Box>
